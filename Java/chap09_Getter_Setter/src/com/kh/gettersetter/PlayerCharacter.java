...
public class PlayerCharacter {
	...
	*/
	...
	public void setHealth(int health) {
		...
		if(health > 0) { // 만약 체력이 0 이상일 경우 체력을 표시
			this.health = health;
	...
	public void setAttackerPower(int attackPower) {
		if (attackPower > 0) {//만약에 파워가 0보다 클 경우
		this.attackPower = attackPower;
		} else {
			this.attackPower = 0;
			System.out.println("파워가 부족합니다.");
		}
	}
	...
	public void displayInfo() {
		...
		System.out.println("공 격 파워 : " + attackPower);
	}
	
	//캐릭터 공격하는 출력 메서드
	public void attack(PlayerCharacter target) {
		System.out.println(name + "이 공격했습니다." + target.getName() + "for" + attackPower + "데미지");
