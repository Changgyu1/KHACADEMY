...
public class DFSGraph {
	...
	/*
	 * adjList : 배열은 인접 리스트를 저장하는 배열 각 노드마다 연결된 노드들을 저장하기위해 LinkedList 객체 배열로 초기화
	 * 
	 */
	/*
	 * 그래프 생성자 그래프의 크기(노드 수)를 받아와서 그래프를 초기화 adjList 배열의 각 원소를 빈 LinkedList 로 초기화
	 * 
	 */
	...
	public void addEdge(int source, int des) {
		...
		// source에 해당하는 LikedList에 des 추가
