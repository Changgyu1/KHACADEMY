		...
		/*while(!isChoice) {
			...
			switch(month) {
				case 3: case 4: case 5:
					...
					isChoice = true; 
					// 위 !가 있을경우 참은 거짓으로 변경되고, 거짓은 참으로 변경되기 때문에
				...
				case 12: case 1: case 2:
					...
					break;
				default :
					System.out.println(month + "달은 잘못된 달입니다. 다시입력해주세요!");
			}
		}*/
		
		//놀이공원을 입장하는데 9살 이상만 티켓을 구매할 수 있기 때문
		//나이를 입력받아 성인 청소년 어린이로 분류한다.
		//while switch case 이용해서 출력하기
		//성인(19~20) 청소년(14~18) 어린이(10~13)
		//이외 나이는 다시 입력하세요.
