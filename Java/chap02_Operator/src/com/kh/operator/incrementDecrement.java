...
public class incrementDecrement {
	...
	public static void main(String[] args) {
		...
		*/
		...
		int val, val2;
		int num1 = 10;
		val = ++num1; //num의 값이 1증가한 후 val 변수에 대입을 하기 때문에 11이 대입됨
		System.out.println(val);
		
		val2 = --num1;//num의 값이 1 감소한 후 val 변수에 대입을 하기 때문에 10이 대입됨
		...
		val3 = num2++; // val3 변수에 기존 num2 값을 대입한 후 num 값이 1 증가됨
		//1번 val3 = num2 값 추가하자
